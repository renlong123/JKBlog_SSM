...
<%--<div id="dg" style="z-index: 9999; position: fixed ! important; top: 70px;margin: auto;width: 85%;min-width: 800px">
...
<div class="container-fluid" style="width: 85%;min-width: 800px">
  <div class="row">
    ...
    <div class="col-2">
      ...
      <div class="fixedLabel">工具</div>
      <div class="fixedLabel">框架</div>
      <div class="fixedLabel">面试题</div>
